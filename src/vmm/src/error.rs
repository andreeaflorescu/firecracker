...
use vmm_config::logger::MetricsConfigError;
...
pub enum VmmActionError {
    ...
    /// The action `ConfigureMetrics` failed either because of bad user input (`ErrorKind::User`) or
    /// an internal error (`ErrorKind::Internal`).
    Metrics(ErrorKind, MetricsConfigError),
